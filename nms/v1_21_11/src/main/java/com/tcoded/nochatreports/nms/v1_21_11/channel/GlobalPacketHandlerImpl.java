package com.tcoded.nochatreports.nms.v1_21_11.channel;
...
public class GlobalPacketHandlerImpl extends GlobalPacketHandler {
    ...
    private void handleBundlePacket(Channel channel, ClientboundBundlePacket bundlePacket) {
        Iterable<Packet<? super ClientGamePacketListener>> list = bundlePacket.subPackets();
        Iterator<Packet<? super ClientGamePacketListener>> iterator = list.iterator();
